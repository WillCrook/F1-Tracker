...
```
cd existing_repo
git remote add origin https://gitlab.com/william23/f1-tracker.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/william23/f1-tracker/-/settings/integrations)
